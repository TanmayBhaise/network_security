...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classification_metric, x_train):
        try:
            ...
            if hasattr(x_train, "iloc"):
                ...
                input_example = x_train[:1]  # Works for numpy array

            # Infer signature safely
            y_pred_sample = best_model.predict(
                x_train[:10]
            )  # small subset for signature
            signature = infer_signature(x_train[:10], y_pred_sample)
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        ## Track the experiements with ml_flow
